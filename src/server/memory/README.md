...
- `context-budget.ts` selects a deterministic bounded item snapshot and renders
  a small model-facing Markdown view.
...
temporary chat, or memory settings are implemented in this slice.
