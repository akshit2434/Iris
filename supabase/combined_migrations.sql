-- COMBINED MIGRATIONS AND SEED FOR IRIS

-- ==========================================
-- MIGRATION: 20260815000000_initial.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260815010000_agent_runtime.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260816000000_chat_titles.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260817000000_memory_foundation.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260818000000_memory_governance.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260819000000_memory_reconciliation_compaction.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260820000000_lazy_chat_persistence.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260821000000_token_context_ledger.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260822000000_memory_lifecycle.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260823000000_reference_history.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260823100000_historical_search_contract.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260824000000_memory_controls_ui.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260825000000_memory_controls_derived_cleanup.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260826000000_memory_upgrade_reconciliation.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260827000000_agent_observability.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260828000000_atomic_existing_thread_turn.sql
-- ==========================================

-- Persist an existing-thread user turn and its agent run atomically. This
-- prevents either an orphan run or an unowned message if one insert fails.
...
begin
  ...
  if not exists (select 1 from public.threads t where t.id = p_thread_id and t.profile_id = p_profile_id and t.archived_at is null) then raise exception 'Chat not found'; end if;
  ...
  update public.messages set agent_run_id = p_run_id
  where id = p_user_message_id and profile_id = p_profile_id and thread_id = p_thread_id;
...
-- ==========================================
-- MIGRATION: 20260828050000_reference_history_observability.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260828100000_memory_consolidation_ranges.sql
-- ==========================================
...
-- ==========================================
-- MIGRATION: 20260828200000_fix_atomic_existing_thread_turn.sql
-- ==========================================
